...
struct MiniEvent_t
{
  ...
  Int_t j_id[maxjets], j_g[maxjets], j_mvav2[maxjets], j_deepcsv[maxjets], j_flav[maxjets], j_hadflav[maxjets], j_pid[maxjets], j_jecf[maxjets];
  Float_t j_pt[maxjets], j_eta[maxjets], j_phi[maxjets], j_mass[maxjets], j_sf[maxjets];
