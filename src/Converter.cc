...
Converter::Converter(std::string fileIn, std::string fileOut, bool reweightBtag, float jec):
  input_(fileIn),ev_(&input_.ev_), bd_(ev_,fileIn,reweightBtag,jec),fileOut_(fileOut){
